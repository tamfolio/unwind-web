...
function SignIn() {
  ...
  return (
    <div className="h-auto bg-gray-50 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-start p-8 md:p-12 lg:ml-15">
        <div className="w-full max-w-md">
          {/* Mobile Back Button */}
          <button
            onClick={handleBack}
            className="lg:hidden flex items-center text-gray-600 hover:text-gray-800 transition-colors mb-8"
          >
            <ArrowLeft className="w-5 h-5 mr-2" />
            Back
          </button>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-purple-700 hover:to-blue-700 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Sign In
            </button>
